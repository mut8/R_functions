...
###################################################
### code chunk number 1: decision-vegan.Rnw:34-38
###################################################
...
###################################################
### code chunk number 2: decision-vegan.Rnw:56-67
###################################################
data(sipoo)
...
###################################################
### code chunk number 3: decision-vegan.Rnw:413-417
###################################################
library(vegan)
data(varespec)
data(varechem)
...
###################################################
### code chunk number 5: decision-vegan.Rnw:426-427
###################################################
plot(orig, dis=c("lc","bp"))


###################################################
### code chunk number 6: decision-vegan.Rnw:436-438
###################################################
...
###################################################
### code chunk number 7: decision-vegan.Rnw:441-442
###################################################
...
###################################################
### code chunk number 9: decision-vegan.Rnw:454-455
###################################################
plot(procrustes(scores(orig, dis="lc"), scores(shuff, dis="lc")))


###################################################
### code chunk number 10: decision-vegan.Rnw:463-466
###################################################
...
###################################################
### code chunk number 11: decision-vegan.Rnw:469-470
###################################################
plot(procrustes(scores(tmp1, dis="lc"), scores(tmp2, dis="lc")))


###################################################
### code chunk number 12: decision-vegan.Rnw:489-491
###################################################
orig
shuff
...
###################################################
### code chunk number 13: decision-vegan.Rnw:496-497
###################################################
plot(procrustes(orig, shuff))


###################################################
### code chunk number 14: decision-vegan.Rnw:510-514
###################################################
...
###################################################
### code chunk number 15: decision-vegan.Rnw:526-530
###################################################
data(dune)
data(dune.env)
summary(dune.env)
...
###################################################
### code chunk number 16: decision-vegan.Rnw:535-536
###################################################
plot(orig, dis="lc")
...
###################################################
### code chunk number 18: decision-vegan.Rnw:560-561
###################################################
plot(orig, display="wa", type="points")
ordispider(orig, col="red")
text(orig, dis="cn", col="blue")
